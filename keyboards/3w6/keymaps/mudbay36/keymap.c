...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Z,           KC_X,           KC_C,             KC_V,           	KC_B,				/*|*/   KC_N,	    		KC_M,	        	KC_COMM,        KC_DOT,         KC_SLSH,
                                    LT(_MUS, KC_ESC), LT(_NAV, KC_SPC), LT(_SYM, KC_BSPC),	/*|*/	LT(_FUN, KC_DEL),	LT(_NUM, KC_ENT),	LALT(KC_LSFT)
	),
	[_NAV] = LAYOUT(
	...
	[_MUS] = LAYOUT(
	KC_TRNS,        KC_TRNS,        KC_MS_UP,         KC_TRNS,            KC_TRNS,            /*|*/   KC_WH_U,            KC_ACL0,            KC_ACL2,        KC_ACL1,       KC_TRNS,
	KC_TRNS,        KC_MS_LEFT,     KC_MS_DOWN,       KC_MS_RIGHT,        KC_TRNS,            /*|*/   KC_WH_D,            KC_BTN1,            KC_BTN2,        KC_BTN3,       KC_TRNS,
	KC_TRNS,        KC_TRNS,        KC_TRNS,          KC_TRNS,            KC_TRNS,            /*|*/   KC_WH_L,            KC_WH_R,            KC_TRNS,        KC_TRNS,       KC_TRNS,
	                                KC_TRNS,          KC_TRNS,            KC_TRNS,            /*|*/   KC_TRNS,            KC_TRNS,            KC_TRNS
    )
    // [_FN] = LAYOUT(
