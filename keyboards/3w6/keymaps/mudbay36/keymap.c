...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Z,           KC_X,           KC_C,           KC_V,           	KC_B,				/*|*/   KC_N,	    		KC_M,	        	KC_COMM,        KC_DOT,         KC_SLSH,
                                    KC_DEL,			LT(_NAV, KC_SPC),  	LT(_SYM, KC_BSPC),	/*|*/	LT(_FUN, KC_DEL),	LT(_NUM, KC_ENT),	KC_ESC
	),
	[_NAV] = LAYOUT(
	KC_ESC,         KC_PGUP,        KC_UP,          KC_HOME,        	KC_LBRC,			/*|*/	KC_RBRC,    		KC_TRNS,        	KC_TRNS,        KC_MINS,        KC_BSLS,
	...
	KC_LGUI,        KC_LALT,        KC_LSFT,        KC_LCTL,        	KC_VOLU,    		/*|*/   KC_TRNS,    		KC_F4,       		KC_F5,          KC_F6,       	KC_F11,
	...
	KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        	KC_TRNS,    		/*|*/   KC_TRNS,    		KC_RCTL,        	KC_RSFT,        KC_RALT,       KC_RGUI,
	KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        	KC_TRNS,    		/*|*/   KC_TRNS,    		KC_TRNS,       		KC_TRNS,        KC_TRNS,       KC_TRNS,
	                                KC_TRNS,        KC_TRNS,        	KC_TRNS,    		/*|*/   KC_TRNS,    		KC_TRNS,       		KC_TRNS
		)
	// [_FN] = LAYOUT(
